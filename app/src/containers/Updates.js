    ...
    return (
        <div className="banner">
            <div className="container">
                  ...
                  <h6 className="font-weight-normal text-muted">A place to see updates on the electronic portfolio project, as managed by the FiveCent Software Systems team.</h6>
                  <img src={process.env.PUBLIC_URL + "/images/updates.svg"} alt="" className="img-fluid w-50" />
            </div>
            <div className="container">
